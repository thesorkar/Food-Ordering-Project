                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="reqFVIsActive" runat="server" ForeColor="Red" 
                                                            ErrorMessage="Price is required" SetFocusOnError="true" Display="Dynamic" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control"
                                                            placeholder="Enter Product Quantity" TextMode="Number"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ForeColor="Red" 
                                                            ErrorMessage="Quantity is required" SetFocusOnError="true" Display="Dynamic" 
                                                            ControlToValidate="txtQuantity">
                                                        </asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ForeColor="Red" 
                                                            ErrorMessage="Quantity must be non negative" SetFocusOnError="true" Display="Dynamic"
                                                            ValidationExpression="^([1-9]\d*|0)$" ControlToValidate="txtQuantity">
                                                        </asp:RegularExpressionValidator>
                                                    </div>
                                                </div>
                                                <div class="form-group">
